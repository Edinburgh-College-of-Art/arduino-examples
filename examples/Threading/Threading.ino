...
//#include "/Users/mhamilt7/Documents/Arduino/libraries/TimedAction.cpp"
...
void setup()
{
  lcd.begin(16, 2); //define the LCD's number of columns and rows:
  changeText();     //fire changeText once to paint the initial string [0]
}
